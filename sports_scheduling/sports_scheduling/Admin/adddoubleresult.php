...
<?php include 'theme/breadcrumbs.php'; ?>
          ...
          <?php
          $sql = "SELECT m.match_code,s.sport_name,s.sport_code,m.match_date,m.match_time,m.match_status,f.facilitator_name,sc.school_name,v.place,st.sport_type,st.sport_type_code from match_schedule m,sports s,facilitator f,schools sc,venue v,sports_type st where s.sport_code = m.sport_code and f.facilitator_code = m.facilitator_code and sc.school_code = m.school_code and v.venue_code = m.venue_code and st.sport_type_code = m.sport_type_code and m.sport_type_code = 'DOUBLESPORTS' group by m.match_code";
...
<center>
  <div class="container">
      <div class="card card-register mx-auto mt-5">
        <div class="card-header bg-success"><?php echo '<h4>
  ...
  while ($row2 = mysqli_fetch_array($r2)) {
            ...
            ?>    
                        ...
                        <div class="col-md-6">
                            ...
                            <strong>Match_code: </strong><input type="text" class="form-control bg-success" readonly name="mcode" value="<?php echo $row['match_code']; ?>"><br />
